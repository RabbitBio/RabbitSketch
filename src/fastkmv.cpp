...
// ═══════════════════════════════════════════════════════════════════════════
// ═══════════════════════════════════════════════════════════════════════════
// 2-bit lex encoding  (A/a→0, C/c→1, G/g→2, T/t→3; all else → 255)
// Shared with HLL and SetSketch for a unified canonical k-mer definition:
...
// ═══════════════════════════════════════════════════════════════════════════
// update  –  2-bit lex rolling + SIMD fmix finalizer + threshold filter
// ═══════════════════════════════════════════════════════════════════════════
...
void FastKMV::update(const char* seq, uint64_t length) {
    ...
    // ── 2-bit lex rolling init ────────────────────────────────────────────
    // canonical = min(fwd_h, rc_h) on packed 2-bit integers.
    const uint64_t kmer_mask = (K >= 32) ? UINT64_MAX
                                          : ((1ULL << (2 * K)) - 1);
